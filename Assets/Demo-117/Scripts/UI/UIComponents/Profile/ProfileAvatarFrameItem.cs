...
{
    public class ProfileAvatarFrameItem : BindablePropertyButton<int>, ICanGetLocator<Entity>
    {
        ...
        protected override void InitUI(bool selected)
        {
            ...
            imgContent.sprite = this.GetService<IProfileService>().GetAvatarFrame(id);
        }
